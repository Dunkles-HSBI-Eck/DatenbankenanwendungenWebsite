...
<button type="button"
  ...
  on:click={onClick}
  aria-label={name}>
  <div class="relative w-full aspect-3/4 bg-neutral-800 flex items-center justify-center">
    <img src="/api/v1/images/covers/{previewImage}" alt={name} class="w-full object-cover block" />
...
<button
	...
	aria-label={name}
>
	<div class="relative flex h-[124px] w-full items-center justify-center bg-neutral-800">
		<img
			src="/api/v1/images/covers/{previewImage}"
			alt={name}
